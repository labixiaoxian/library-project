...
public class BorrowInfo implements Serializable {
	...
	@Override
	public int hashCode() {
		return Objects.hash(book, bookId, borrowDate, borrowState, examineState, id, renewState, returnDate, userInfo,
				userId);
	}
	...
	public String toString() {
		return "BorrowInfo [id=" + id + ", userId=" + userId + ", bookId=" + bookId + ", borrowDate=" + borrowDate
				...
				+ ", renewState=" + renewState + ", userInfo=" + userInfo + ", book=" + book + "]";
	}
