...
public class BorrowInfoServiceImpl extends BorrowInfoService {
	...
	public List<BorrowInfo> refuseBorrowInfosPagination(Integer currentPage, Integer pageSize) {
		return borrowInfoMapper.getByBorrowStatePagination(-1, (currentPage - 1) * pageSize, pageSize);
	}
	...
	public List<BorrowInfo> getBorrowInfosByBookId(Integer bookId) {
		// TODO Auto-generated method stub
		return borrowInfoMapper.getBorrowInfosByBookId(bookId);
	}
